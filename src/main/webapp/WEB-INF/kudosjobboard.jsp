                                ...
                                <c:forEach var="job" items="${jobs}">
                                    ...
                                    <tr class="text-center">
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <c:choose>
                                                    <c:when test="${!votedJobs.contains(job)}">
                                                        <td>
                                                            <form action="/jobs/vote/${job.id}">
                                                                <button class="btn btn-outline-warning title btn-sm" type="submit"><img src="/imgs/smiley.png" width="15" height="15"></button>
                                                            </form>
                                                        </td>
                                                    </c:when>
                                                    <c:otherwise>
                                        ...
                                        <td><a href="${job.url}" class="btn btn-outline-info text-white btn-sm">Link</a></td>
                                    </tr>
                                    </c:if>
                                </c:forEach>
                                </tbody>
