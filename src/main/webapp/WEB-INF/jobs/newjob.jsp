    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <div class="card mt-5 mb-3 p-3 bg-info text-dark">
                <div class="card-body">
                    <h5 class="card-title text-dark text-center title">New Job Application</h5>
                    <div class="form-group">
                        <form:form action="/new/job" method="post" modelAttribute="job">
                            <div class="row mt-4">
                                <div class="col">
                                    <form:label path="title">Job Title</form:label>
                                    <form:input placeholder="Enter job title" class="form-control" path="title"/>
                                </div>
                                <div class="col">
                                    <form:label path="jobType">Job Type</form:label>
                                    <form:select class="form-control" path="jobType">
                                        <form:option value="NONE" label="--- Select ---"/>
                                        <form:option value="Full-time" label="Full-Time"></form:option>
                                        <form:option value="Part-time" label="Part-Time"></form:option>
                                        <form:option value="Internship" label="Internship"></form:option>
                                        <form:option value="Apprenticeship" label="Apprenticeship"></form:option>
                                        <form:option value="Freelance" label="Freelance"></form:option>
                                        <form:option value="Contract" label="Contract"></form:option>
                                        <form:option value="Volunteer" label="Volunteer"></form:option>
                                    </form:select>
                                </div>
                            </div>
                            <div class="row mt-4">
                                ...
                                <div class="col">
                                    ...
                                    <form:select class="form-control" path="status">
                                        ...
                                        <form:option value="Recruiter Contact" label="Recruiter Contact"></form:option>
                                        <form:option value="Interviewing" label="Interview"></form:option>
                                        <form:option value="Rejected" label="Rejected"></form:option>
                                        <form:option value="Accepted" label="Accepted"></form:option>
                                        <form:option value="Ghosted" label="Ghosted"></form:option>
                                    </form:select>
<%--                                    <form:input type="hidden" path="lastStatus" value="null" />--%>
                                </div>
                            </div>
                            <div class="row mt-4">
                                <div class="col">
                                    <form:label path="company">Company</form:label>
                                    <form:input placeholder="Enter company" class="form-control" path="company"/>
                                </div>
                                <div class="col">
                                    <form:label path="jobLocation">Job Location</form:label>
                                    <form:input placeholder="Enter job location" class="form-control" path="jobLocation"/>
                                </div>
                            </div>
                            <div class="row mt-4">
                                <div class="col">
                                    <form:label path="url">Link to Job Posting</form:label>
                                    <form:input placeholder="Enter url" class="form-control" path="url"/>
                                </div>
                            </div>
                            <div class="row mt-4">
                                <div class="col">
                                    <form:label path="description">Description</form:label>
                                    <form:textarea placeholder="Enter job description" class="form-control" path="description"/>
                                </div>
                                <div class="col">
                                    <form:label path="notes">Notes</form:label>
                                    <form:textarea placeholder="Enter your notes" class="form-control" path="notes"/>
                                </div>
                            </div>
                            ...
                            <input class="btn btn-outline-light mt-2 align-self-end title" type="submit" value="Add">
                        </form:form>
                    </div>
                </div>
            </div>
